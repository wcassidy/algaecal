	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="row">
				...
				<div class="col-12 hidden-xs"><h2>A proven, doctor-approved 100% natural solution for women with osteoporosis</h2></div>
			</div>
			<div class="row">
				<div class="col-12">
					<span class="fa fa-star star-filled"></span><span class="fa fa-star star-filled"></span><span class="fa fa-star star-filled"></span><span class="fa fa-star star-filled"></span><span class="fa fa-star star-filled"></span>225 Reviews</div>
			</div>
			<div class="row">
				<div class="col-12">
					<dl>
						<dt class="checked">Plant-Based</dt>
						<dd>Super absorbable calcium, magnesium and trace minerals from algae!</dd>
						<dt class="checked">Guarantee</dt>
						<dd>To increase bone density in 6 months when taken with Strontium Boost!</dd>
						<dt class="checked">Clinical Doses</dt>
						<dd>Of vitamins D3, K2, boron and magnesium!</dd>
					</dl>
				</div>
			</div>
			<div class="row product-description hidden-xs">
				<div class="col-12">
					<table>
						<tr>
							<th></th>
						...
						<tr>
							<td>Description:</td>
							<td>90 easy to swallow veggie capsules</td>
						</tr>
						<tr>
							<td>Suggested Use:</td>
							<td>4 caps daily (2 caps twice a day with meals)</td>
						</tr>
						<tr>
							<td>Availability:</td>
							<td class="blue-highlight">IN STOCK leaves warehouse in 1 business day</td>
						</tr>
						<tr>
							<td>Shipping Fee:</td>
							<td class="green-u-highlight">Free Shipping Everywhere</td>
						</tr>
					</table>
				</div>
			</div>				
			<div class="row external-links">
				<div class="col-sm-5 col-xs-12"><a class="friend" href="#">Tell a Friend</a>
				</div>
				<div class="col-sm-7 col-xs-12"><a class="doctor" href="#">Take This to Your Doctor</a>
				</div>
			</div>				
		</div>
	</div>
